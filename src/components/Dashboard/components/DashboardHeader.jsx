              ...
              <div className="max-h-80 overflow-y-auto">
                {notifications.length > 0 ? (
                  notifications.map((notification) => (
                    <div
                      key={notification.id}
                      className={`p-3 border-b border-gray-100 hover:bg-gray-50 transition duration-150 ${
                        !notification.read ? "bg-blue-50" : ""
                      }`}
                    >
                      <div className="flex items-start gap-3">
                        <div
                          className={`rounded-full h-2 w-2 mt-1.5 flex-shrink-0 ${
        ...
        <div className="relative">
          ...
          >
            <div className="hidden md:flex flex-col items-end text-right">
              ...
              <span className="text-xs text-blue-100 leading-tight">{profile.email}</span>
            </div>
          ...
          {dropdownOpen && (
            ...
            >
              ...
              >
                <IoMdSettings className="w-4 h-4 mr-3" />
                Logout
              </button>
            </motion.div>
          )}
