    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 items-center justify-center px-6 sm:px-12 ">
        ...
        <div className="text-white ml-16">
          <h1 className="text-4xl  font-hindi sm:text-3xl font-bold mb-6 sm:leading-hindi truncate ">
          क्या आप <span className="text-5xl font-bold text-orange-300">Teacher</span> बनना चाहते हैं?</h1>
