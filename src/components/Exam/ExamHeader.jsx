...
//   const examDuration = allQuestion?.duration; // Don't default to 0 here
//   const [timeLeft, setTimeLeft] = useState(null); // Initialize as null
//   const [timerStarted, setTimerStarted] = useState(false);

//   // Initialize timer only when we have a valid duration
//   useEffect(() => {
...
//   // Timer logic - only runs when timeLeft is not null
//   useEffect(() => {
...
//         if (prevTime <= 1) {
//           clearInterval(timer);
//           handleSubmit(); // Auto-submit only when time actually runs out
//           return 0;
//         }
//         return prevTime - 1;
//       });
...
//     if (seconds === null) return "--:--"; // Show placeholder while loading
