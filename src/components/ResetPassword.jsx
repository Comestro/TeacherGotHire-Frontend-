...
const ResetPassword = () => {
  ...
  const passwordStrength = (pwd) => {
    ...
    if (score >= 2)
      return { label: "Medium", color: "bg-yellow-400", score: 2 };
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className={`w-full pl-11 pr-12 py-3.5 bg-white border rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all outline-none ${
                          password ? "border-slate-300" : "border-slate-200"
                        }`}
                        required
                      />
                      <button
                    ...
                    {password && (
                      <div className="mt-2 px-1">
                        ...
                        <div className="flex h-1.5 w-full bg-slate-100 rounded-full overflow-hidden gap-1">
                          <div
                            className={`h-full rounded-full transition-all duration-300 ${strength.score >= 1 ? strength.color : "bg-transparent"}`}
                            style={{ width: "33%" }}
                          />
                          <div
                            className={`h-full rounded-full transition-all duration-300 ${strength.score >= 2 ? strength.color : "bg-transparent"}`}
                            style={{ width: "33%" }}
                          />
                          <div
                            className={`h-full rounded-full transition-all duration-300 ${strength.score >= 3 ? strength.color : "bg-transparent"}`}
                            style={{ width: "33%" }}
                          />
                        </div>
