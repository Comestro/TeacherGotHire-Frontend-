          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              <div className="flex flex-col items-center">
                <span className="text-sm font-medium text-gray-700 group-hover:text-gray-900">Teacher</span>
              </div>
            </button>
            <button
            ...
            <div className="hidden md:block w-1/2 space-y-8 animate-slide-up">
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4 bg-white/60 backdrop-blur-sm p-4 rounded-2xl border border-white/50 shadow-sm">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-800">Large Talent Pool</h3>
                    <p className="text-sm text-gray-500">Access thousands of qualified teachers</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4 bg-white/60 backdrop-blur-sm p-4 rounded-2xl border border-white/50 shadow-sm">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-800">Verified Profiles</h3>
                    <p className="text-sm text-gray-500">Screened candidates for quality assurance</p>
                  </div>
                </div>
              </div>
            </div>
