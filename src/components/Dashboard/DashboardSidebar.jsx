...
const Sidebar = ({ isOpen, setIsOpen }) => {
  ...
  return (
    <>
      {/* Sidebar Drawer */}
      <div
        className={`fixed top-0 left-0 h-full w-72 bg-white transform transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        <div className="flex flex-col h-screen bg-white">
          ...
          {/* profile section */}
          <div className="flex items-center gap-3 py-3 bg-background px-4 mx-3 my-3 rounded-lg">
