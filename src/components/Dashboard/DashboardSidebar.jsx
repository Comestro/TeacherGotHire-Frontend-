...
const Sidebar = () => {
  ...
  return (
    <div className="fixed w-60 h-screen flex flex-col items-center py-6 ">
  {/* Profile Section */}
  <div className="text-center mb-8">
    ...
    <p className="text-md text-gray-700">{profile.email || "email@example.com"}</p>
  </div>
    ...
    <NavLink
      ...
      className={({ isActive }) =>
        `block py-2 px-4 rounded-md  ${
          isActive ? "bg-teal-700 text-white font-semibold" : "text-gray-600 font-semibold"
