  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-white to-teal-100 p-6">
      <div className="max-w-8xl mx-auto">
        ...
        {/* Header Section */}
        <div className="bg-white rounded shadow-xl overflow-hidden mb-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6 border-l-4 border-green-500">
              ...
              <div className="flex items-center space-x-3">
                ...
                ></div>
                <span
                  className={`font-semibold ${status ? "text-green-700" : "text-red-700"}`}
                >
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {category.subjects.map((subj) => (
                          <span
                            key={subj.id}
                            className="bg-indigo-100 text-indigo-800 px-3 py-1 rounded-full text-sm font-medium border border-indigo-200"
                          >
                            {subj.subject_name}
                          </span>
                        ))}
