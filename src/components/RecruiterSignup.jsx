        ...
        <div className="w-full">
          ...
          <form onSubmit={handleOTPSubmit} className="space-y-6">
            ...
            <div className="space-y-3">
              <Button
                type="submit"
                className={`w-full bg-teal-600 hover:bg-teal-700 text-white py-3 rounded-lg font-bold shadow-sm ${
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <div className="relative">
                <Input
                  className={`w-full px-4 py-2.5 bg-white border rounded-lg outline-none ${
                    dirtyFields.Fname ? "border-teal-500" : "border-slate-300"
                  }`}
            ...
            <div>
              ...
              <div className="relative">
                <Input
                  className={`w-full px-4 py-2.5 bg-white border rounded-lg outline-none ${
                    dirtyFields.Lname ? "border-teal-500" : "border-slate-300"
                  }`}
        ...
        <div className="mt-8 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              className="flex items-center justify-center px-4 py-2.5 border border-slate-200 rounded-lg hover:bg-slate-50 hover:border-slate-300 group"
            >
            ...
            <div className="hidden md:block w-1/2 space-y-8 ">
              <div className="space-y-4">
                <h1 className="text-4xl lg:text-5xl font-extrabold text-slate-900 leading-tight">
                  Find the Perfect <br />
                  <span className="text-teal-600">Teaching Talent</span>
                </h1>
                <p className="text-lg text-slate-600 max-w-md">
                  Connect with qualified educators and streamline your
                  recruitment process with our advanced platform.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4 bg-white p-5 rounded-lg  border border-slate-200 shadow-sm">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500">
                      Access thousands of qualified teachers
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4 bg-white p-5 rounded-lg  border border-slate-200 shadow-sm">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500">
                      Screened candidates for quality assurance
                    </p>
                  </div>
                </div>
              </div>
