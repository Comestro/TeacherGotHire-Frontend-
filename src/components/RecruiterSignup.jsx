        ...
        <div className="w-full">
          ...
          <form onSubmit={handleOTPSubmit} className="space-y-6">
            ...
            <div className="space-y-3">
              <Button
                type="submit"
                className={`w-full bg-teal-600 hover:bg-teal-700 text-white py-3 rounded-xl font-bold shadow-md ${
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <div className="relative">
                <Input
                  className={`w-full px-4 py-2.5 bg-white border rounded-xl outline-none ${
        ...
        <div className="mt-8 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              className="flex items-center justify-center px-4 py-2.5 border border-slate-200 rounded-xl hover:bg-slate-50 hover:border-slate-300 group"
            >
