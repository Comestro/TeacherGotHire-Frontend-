            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900 leading-tight">
                  Create and conduct your first exam as a teacher in{" "}
                  <span className="text-teal-600">under an hour!</span>
                </h1>
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li
                    key={index}
                    className="flex items-center text-lg text-slate-600 group"
                  >
              ...
              <div className="pt-4">
                <button className="px-8 py-4 bg-slate-800 text-white rounded-xl font-bold shadow-sm hover:bg-slate-900 hover:shadow-md transform hover:-translate-y-0.5 transition-all duration-300">
