...
import { createQuestion, updateQuestion, getExamById, deleteQuestion } from '../../services/adminManageExam';
        ...
        <div className="bg-white rounded-2xl shadow p-8 mb-8 border border-gray-100">
          ...
          <div className="flex items-center justify-between">
            ...
            {/* <button
              ...
              className="bg-gradient-to-r from-teal-600 to-teal-700 hover:from-teal-700 hover:to-teal-800 text-white px-6 py-3 rounded-xl flex items-center shadow-lg hover:shadow-xl transition-all transform hover:scale-105"
            >
        ...
        {selectedLanguage === 'all' ? (
          ...
          <div className="space-y-8">
            {['English', 'Hindi'].map(language => {
              ...
              return (
                <div key={language} className="bg-white rounded-2xl shadow border border-gray-100 overflow-hidden">
                  <div className={`px-6 py-4 ${
                    ...
                    <div className="flex items-center justify-between">
                      <h2 className="text-xl font-bold flex items-center">
                        {language === 'English' ? <FiGlobe className="w-6 h-6 mr-2" /> : <FiBook className="w-6 h-6 mr-2" />}
                        {language} Questions
                      </h2>
            ...
            {questions.length === 0 && (
              <div className="bg-white rounded-2xl shadow border border-gray-100 p-12 text-center">
                <div className="max-w-md mx-auto">
                  ...
                  <h3 className="text-xl font-medium text-gray-900 mb-2">No Questions Added Yet</h3>
