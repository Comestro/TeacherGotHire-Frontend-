...
const ExamCenterModal = ({
  ...
  const filteredCenters = React.useMemo(() => {
    ...
    return centers.filter((center) => center?.pincode?.includes(pincodeFilter));
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-black/60 via-black/50 to-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-fadeIn">
      <div className="bg-white rounded  relative shadow-2xl overflow-hidden w-full max-w-xl transform transition-all animate-scaleIn">
              ...
              <div>
                ...
                {pincodeFilter && (
                  <div className="mt-2 flex items-center text-xs text-blue-600 bg-blue-50 px-3 py-1.5 rounded-lg">
                    ...
                    Showing centers in pincode:{" "}
                    <span className="font-semibold ml-1">{pincodeFilter}</span>
                  </div>
                )}
              </div>
                          ...
                          <div className="flex items-start">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-blue-700 mt-1">
                                No centers available for pincode "
                                <span className="font-semibold">
                                  {pincodeFilter}
                                </span>
                                ". Try a different pincode or clear the filter.
                              </p>
                            </div>
                          </div>
                        </div>
