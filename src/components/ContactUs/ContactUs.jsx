            ...
            <div className="space-y-4">
              <div className="flex items-center">
                <span className="text-blue-600">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="teal" className="bi bi-telephone" viewBox="0 0 16 16">
              ...
              <div className="flex items-center">
                <span className="text-blue-600">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="teal" className="bi bi-google" viewBox="0 0 16 16">
              ...
              <div className="flex items-center">
                <span className="text-blue-600">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="teal" className="bi bi-building" viewBox="0 0 16 16">
