...
const ExamLevels = () => {
  ...
  }, [dispatch, basicData, prefrence, educationData]);
  ...
  const handleSubjectChange = (e) => {
    ...
    setShowExamCard(true); // Ensure the exam card is shown upon subject selection
  ...
  return (
    <div className="flex flex-col items-center p-4">
      ...
      {/* Display Exam Card */}
      {selectedSubject && examSet && showExamCard && (
