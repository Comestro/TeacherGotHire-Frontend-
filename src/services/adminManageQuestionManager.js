...
export const updateAssignedUserManager = (id, data) => apiService.update(endpoint, id, data);
export const deleteAssignedUserManager = (id) => apiService.delete(endpoint, id);
